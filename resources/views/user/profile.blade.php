    ...
    <div class="card">
        ...
        <div class="row">
            ...
            <div class="col">
                ...
                <input name="timezone" id="timezone" list="timezoneOptions" value="{{ $user->timezone }}"
        ...
        <div class="row form-group mb-2">
            ...
            <div class="col">
                ...
                <input type="file" name="photo" id="photo" accept="image/png, image/gif, image/jpeg"
                       class="form-control form-control-lg">
                @if($user->photo)
                    <img src="/asset/upload/company/{{ \Illuminate\Support\Str::slug($user->company->name, '_') }}/{{ $user->photo }}"
                         height="128" alt="" class="mt-1">
                @endif
            </div>
        </div>
        <div class="row form-group mb-2">
        ...
        <div class="row">
            <div class="col">
                ...
                <button type="button" onclick="Notification.requestPermission()" class="btn btn-warning text-white">
                    <i class="las la-bell"></i> {{ __('Enable push notifications') }}
                </button>
            </div>
        </div>
