...
@section('content')
    ...
    <div class="row">
        <div class="col">
            <a href="{{ url('/asset/upload/example/hammer_lead_example_20221212.csv') }}" rel="noopener" target="_blank" class="btn btn-outline-success">{{ __('Download example file') }} <i class="las la-file-csv"></i></a>
        </div>
    </div>
