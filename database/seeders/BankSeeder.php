...
class BankSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        //Andorra
        DB::table('bank')->insert(['country'=> 'ad', 'name' => 'Andbank', 'phone' => '+376739011', 'email' => 'info@andbank.com', 'website' => 'https://www.andbank.com']);
        DB::table('bank')->insert(['country'=> 'ad', 'name' => 'Crèdit Andorrà, SA', 'phone' => '+376888888', 'email' => 'info@creditandorra.ad', 'website' => 'https://comercial.creditandorragroup.ad/en']);
        DB::table('bank')->insert(['country'=> 'ad', 'name' => 'Mora Banc Grup, SA', 'phone' => '+376884884', 'email' => 'morabanc@morabanc.ad', 'website' => 'https://www.morabanc.ad/']);
