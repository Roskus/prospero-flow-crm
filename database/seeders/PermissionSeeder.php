    ...
    public function permissions(): array
    {
        return [
            ...
            [
                ...
                'name' => 'read rrhh',
                'guard_name' => 'web',
                'module_id' => Module::HUMAN_RESOURCES,
            ],
            [
                'roles' => ['SuperAdmin', 'CompanyAdmin'],
                'name' => 'create rrhh',
